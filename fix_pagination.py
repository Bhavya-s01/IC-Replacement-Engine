"""
fix_pagination.py - Fixes pagination with correct DigiKey selectors.
Run: python fix_pagination.py
Then: python test_scrape.py  (with max_pages=3)
"""
...
content = r'''"""Playwright + Edge scraper for DigiKey - v5 pagination fixed."""
...
print("")
print("Now edit test_scrape.py: change max_pages=1 to max_pages=3")
print("Then run: python test_scrape.py")